...
tmq پردازش همزمان چندین فایل TOML را پشتیبانی می‌کند و آن را برای پردازش دسته‌ای، مدیریت پیکربندی و کارهای اتوماسیون مناسب می‌سازد.
...
### به‌روزرسانی دسته‌ای با پشتیبان‌گیری
```bash
#!/bin/bash
